...
public class DeelanActivity extends Activity {
    ...
    public final class Activity extends DeelangObject {
        ...
        public void moveToNextScreen(DeelangObject screenName) {

            if (screenName.toString().equals("MainActivity")) {
                startActivity(new Intent(DeelanActivity.this, MainActivity.class));
            }
            if (screenName.toString().equals("NewActivity")) {
                startActivity(new Intent(DeelanActivity.this, NewActivity.class));
            }
        }

        public void toast(DeelangObject message) {

            Toast.makeText(DeelanActivity.this, message.toString(), Toast.LENGTH_LONG).show();
        }
